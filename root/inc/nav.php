...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top" style="background-color: #041e41; color: #ffcd00; height: 65px;">
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo ROOT_URL?>pages/about.php">About</a>
      </li>
    ...
    <form class="form-inline my-2 my-lg-0">
        ...
        <?php } else {; ?>
            <ul class="navbar-nav mr-auto" style="padding-right: 10px;">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo ROOT_URL?>pages/userPage.php?id=<?php echo $userID; ?>"><?php echo $firstName; ?></a>
                </li>
